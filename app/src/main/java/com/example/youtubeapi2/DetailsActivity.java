...
import com.example.youtubeapi2.adapters.CommentAdapter;
import com.example.youtubeapi2.models.YoutubeCommentModel;
...
public class DetailsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private static String GOOGLE_YOUTUBE_API = "AIzaSyA1BPTpx6ebcNTJoilRiVFYCh048LAsN-U";
